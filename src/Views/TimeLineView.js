...
export default function TimeLineView() {
    ...
    useEffect(() => {
       ...
       // ---------Animation for the header text and SVG drawing---------------
        ...
        const tl1 = gsap.timeline({
            scrollTrigger: {
                scroller: ".timeline-view-container",
                trigger: ".paraSec",
                start: "top 90%",
        ...
        const tl2 = gsap.timeline({
            scrollTrigger: {
                ...
                scroller: ".timeline-view-container", // Adjust this to the container of the SVG
        ...
        const tl3=gsap.timeline({
            scrollTrigger: {
                ...
                scroller: ".timeline-view-container", // The container that is being scrolled
    ...
    useEffect(() => {
        ...
        const scrollContainer = document.querySelector('.timeline-view-container');
        const handleScroll = () => {
    ...
    return (
        <div className="timeline-view-container" ref={parentDivRef}>
            ...
            <div className="foreground-content">
                <div className="full-screen-container">
                    <div className="background-svg">
                        <BackgroundLine parentRef={parentDivRef} />
                    </div>
